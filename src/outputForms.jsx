...
const OutputForms = ({ handleLogout }) => {
    ...
    function input(doc) {
        ...
        doc.text(productTitle.toString(), 61, 39);

        doc.text(productCategory.toString(), 61, 49);
        ...
        doc.text(companyNameSlice.toString(), 156, 59);

        doc.text(shipDateSlice.toString(), 61, 64);
        doc.text(shipTime.toString(), 61, 69);
